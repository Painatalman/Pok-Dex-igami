...
export const ROSTER: RosterEntry[] = [
  ...
  { id: 10, name: "Caterpie", gen: 1, fold: "caterpillar", color: "green" },
  { id: 16, name: "Pidgey", gen: 1, fold: "bird", color: "brown" },
  { id: 25, name: "Pikachu", gen: 1, fold: "mouse", color: "yellow" },
  { id: 37, name: "Vulpix", gen: 1, fold: "fox", color: "red" },
  { id: 39, name: "Jigglypuff", gen: 1, fold: "ball", color: "pink" },
  { id: 41, name: "Zubat", gen: 1, fold: "bat", color: "blue" },
  ...
  { id: 98, name: "Krabby", gen: 1, fold: "crab", color: "orange" },
  ...
  { id: 417, name: "Pachirisu", gen: 4, fold: "squirrel", color: "blue" },
